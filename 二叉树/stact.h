...
#define INC_SIZE    5
#define StactDataType BinTreeNode*
//链表栈
...
void ListStactPush(ListStact *plt, StactDataType item);
void ListStactshow(ListStact *plt);
void ListStactPop(ListStact *plt);
bool ListStactEmpty(ListStact *plt);
StactDataType ListStactTop(ListStact *plt);
